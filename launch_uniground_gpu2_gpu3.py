...
mkdir -p logs/uniground_v6 logs/uniground_v6/second_host_smoke train_data/uniground_v6 models/uniground_v6
...
cd /root/autodl-tmp/BRA_Project
export PATH="/root/miniconda3/bin:$PATH"
/root/miniconda3/bin/python run_uniground_eval.py \
  --model qwen3-vl-4b \
  --dataset pope \
  --method base \
  --mini_test 4 \
  --output_dir /root/autodl-tmp/BRA_Project/logs/uniground_v6/second_host_smoke && \
/root/miniconda3/bin/python run_uniground_eval.py \
  --model qwen3-vl-4b \
  --dataset pope \
  --method external_global_prior \
  --mini_test 4 \
  --external_encoder /root/autodl-tmp/BRA_Project/models/clip-vit-large-patch14 \
  --output_dir /root/autodl-tmp/BRA_Project/logs/uniground_v6/second_host_smoke
' > /root/autodl-tmp/BRA_Project/logs/uniground_v6/gpu3_qwen4b_smoke.log 2>&1 &

ps -eo pid,etimes,cmd | grep -E "export_universal_coco_payload|train_universal_plugin|run_uniground_eval.py --model qwen3-vl-4b" | grep -v grep
"""
