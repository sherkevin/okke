#!/usr/bin/env python3
"""
Train the internal, model-coupled projector `Phi_calib`.

This script is intentionally kept as the training entrypoint for the legacy
internal path that maps model-native visual states into the active model's
lexical space. It should now be interpreted as an internal baseline/control,
not as the route to a strict universal hot-swappable plugin.
"""
