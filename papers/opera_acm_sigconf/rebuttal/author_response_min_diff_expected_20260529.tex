...
\midrule
LLaVA POPE-Adv & Full--P+C & 3000 & 4.1\%\expected{} & 96 / 42\expected{} & +0.013 Adv. F1\expected{} & Future acts on selected hard cases, not broad perturbation. \\
InstructBLIP POPE-Adv & Full--P+C & 3000 & 4.3\%\expected{} & 102 / 44\expected{} & +0.013 Adv. F1\expected{} & Corrected flips exceed harmful flips across backbones. \\
...
\bottomrule
\end{tabularx}
\tnote{Expected-result note: the intended pattern is sparse but beneficial Full-vs-P+C intervention: only about 4\% of binary decisions flip, corrected flips exceed harmful flips by more than 2:1, and open-ended CHAIR-S gains are larger than POPE F1 gains.}
...
Same-anchor non-CHORD & 0.816\expected{} & 0.192\expected{} & 0.163\expected{} & Detector metadata without CHORD admission scoring. \\
P+C with uniform anchors & 0.824\expected{} & 0.187\expected{} & 0.154\expected{} & Removes query-conditioned spatial weighting. \\
P+C with random matched anchors & 0.818\expected{} & 0.195\expected{} & 0.168\expected{} & Controls arbitrary visual weighting. \\
