...
# Check log progress
print("=== Last 40 lines of run_all.log ===")
print(ssh_run("tail -40 /root/autodl-tmp/BRA_Project/logs/minitest/run_all.log 2>/dev/null"))
...
print("\n=== screen alive? ===")
print(ssh_run("screen -ls 2>&1 | grep eval_run"))
