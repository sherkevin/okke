#!/usr/bin/env python3
"""
Legacy UniGround v1 evaluation entry.

This file is intentionally preserved as a control/compatibility runner for the
pre-v2 universal path. It should not receive new method logic beyond break-fix
maintenance required to keep old checkpoints/results readable.

All future universal-path development must move to the dedicated v2 runtime and
