...
def build_mirage_prompt(sample: dict) -> str:
...
def run_eval(args):
    ...
    for idx, sample in enumerate(pending):
        ...
        try:
            ...
            prompt = build_mirage_prompt(sample)
            result = infer_mirage(
...
def parse_args():
    ...
    p.add_argument("--dataset_file", type=str, default="/root/autodl-tmp/A-OSP_Project/data/benchmarks/mirage/mirage_manifest.jsonl")
