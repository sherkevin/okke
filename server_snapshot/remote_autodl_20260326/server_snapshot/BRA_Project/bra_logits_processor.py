"""
Canonical BRA LogitsProcessor implementation.

This file is the single source of truth for BRA mathematics. Legacy operator
wrappers should delegate to this module instead of maintaining independent
intervention logic.
"""
